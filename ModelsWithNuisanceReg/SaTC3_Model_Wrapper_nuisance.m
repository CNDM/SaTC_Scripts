function SaTC3_Model_Wrapper_nuisance()
...
%                     SaTC3_QuestionModel_nuisance(subs(s))
%                 else
%                     SaTC3_QuestionModel_with_nr_nuisance(subs(s))
%                 end
%             case 2  % Benefit
%                 if nonResponses{r+1,s+1} == 0   % if no missed responses
%                     SaTC3_BenefitModel_nuisance(subs(s))
%                 else
%                     SaTC3_BenefitModel_with_nr_nuisance(subs(s))
%                 end
%             case 3  % Decision
%                 if nonResponses{r+1,s+1} == 0   % if no missed responses
%                     SaTC3_DecisionModel_nuisance(subs(s))
%                 else
%                     SaTC3_DecisionModel_with_nr_nuisance(subs(s))
%                 end
%         end
%     end
% end
...
%%  Building a Decision model, including Attractiveness and Intrusiveness 
    for s = 1:length(subs)
        SaTC3_AI_DecisionModel_nuisance(subs(s));
    end
% ****************************************************************************
