function SnPMBatch_script_Question005(s)
%-----------------------------------------------------------------------
...
sNum = num2str(s(1));
output_header = '/Users/CNDM/Dropbox/SaTCPrivacyGrant/SaTC3/fMRIAnalyses/SnPM/SnPM_Question_005/'
%-----------------------
%   Dropbox Directory
...
modeldir = sprintf('%s%s_3D/Question/Question_Model/',datadir, sNum);
...
for c=1:cons
    ...
    for sub=1:length(s)
        modeldir = sprintf('%s%s_3D/Question/Question_Model/',datadir, num2str(s(sub)));
        if c<10
