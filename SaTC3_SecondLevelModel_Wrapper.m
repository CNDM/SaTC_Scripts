function SaTC3_SecondLevelModel_Wrapper()
...
SaTC3_SecondLevelContrast_SimpleModel(subs,'Benefit');
SaTC3_SecondLevelContrast_SimpleModel(subs,'Question');
SaTC3_SecondLevelContrast_SimpleModel(subs,'Decision');

% ****************************************************************************

% ****************************************************************************
%% Building a second level AI_Decision Model
SaTC3_SecondLevelContrast_AIDecisionModel(subs);
