function SaTC3_DecisionModel(s)
...
if ~exist(fullfile(mriSubdir,'Decision1','Decision_Model'))
    mkdir(fullfile(mriSubdir,'Decision1','Decision_Model'));
end
modelDir = fullfile(mriSubdir,'Decision1','Decision_Model');
    DecisionSession = [];
...
%%
matlabbatch{1}.spm.stats.fmri_spec.sess.cond.name = 'Decision';
...
%%
matlabbatch{1}.spm.stats.fmri_spec.sess.cond.pmod.name = 'Willingness';
