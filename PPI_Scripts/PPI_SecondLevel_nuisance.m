...
%-----------------------
%   Dropbox Directory
ppidir = '/Users/CNDM/Dropbox/SaTCPrivacyGrant/SaTC3/fMRIAnalyses/PPI_Analysis_nuisance/';
datadir = '/Users/CNDM/Dropbox/SaTCPrivacyGrant/SaTC3/fMRIAnalyses/fMRI_Data/ReconScans/';
%------------------------
 for c = contrasts %Loop through contrasts
        ...
        for v = voi
            ...
            for spec = specific
                ...
                conspm=[datadir '301_3D/Decision1/AI_Decision_Model_nuisance/' c{:} '_PPI/' v{:} '/' v{:} '_' spec{:}  '/SPM.mat'];
                cmd = ['load ' conspm];
                eval(cmd);
                ...
                for contrasts=1:cons
                    ...
                    index = 1;
                    for sub = subs
                        condir = sprintf('%s%d_3D/Decision1/AI_Decision_Model_nuisance/%s_PPI',datadir,sub,c{:});
